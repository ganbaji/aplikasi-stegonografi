...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Aplikasi Stegonografi</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Ganang Bayu Aji</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/encrypt" class="nav-link">
              ...
              <p>
                Encryption and Insert
              </p>
            </a>
          </li>
          <li class="nav-item">
            <a href="/descrypt" class="nav-link">
              <i class="nav-icon fas fa-lock-open"></i>
              <p>
                Descrypt and Extract
              </p>
            </a>
          </li>
          <li>
            <a class="btn btn-danger mt-2" href="{{ route('reset') }}" >
              Reset Session
            </a href="">
          </li>
        </ul>
